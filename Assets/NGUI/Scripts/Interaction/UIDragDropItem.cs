...
#region Common functionality
	...
	protected virtual void Start ()
	{
		...
		if (transform.position.z < _minZ)
			_minZ = transform.localPosition.z;
	...
	void OnPress (bool isPressed) { 
		if (isPressed) 
		{
			...
			_minZ -= .1f;
			mTrans.localPosition = new Vector3(mTrans.localPosition.x,mTrans.localPosition.y,_minZ);
			Debug.Log("local pos: " + mTrans.localPosition);
		};
	}
	...
	void OnDrag (Vector2 delta)
	{
		...
		Debug.Log("on move: " + mTrans.localPosition);
	}
